...
export default function ScatterPlot({ data, width = 800, height = 400 }) {
  const svgRef = useRef();
  ...
  useEffect(() => {
    ...
    svg.selectAll("circle")
      ...
      .on("mouseover", function (event, d) {
        ...
        tooltip.html(`Hours/day: ${d.hours}<br/>Anxiety: ${d.anxiety}`);
      })
    ...
    svg.append("text")
      ...
      .text("Hours of Music Listening vs. Anxiety Score");
